# original author: Michael Knight, Jan 28, 2009
# updated by: mberntso, Mar 20, 2016

#!/usr/bin/python

# uses terminal input of data
import sys
...
print "If knapsack can hold %d units, maximum value is %d," % (maxCost,answer[0])
